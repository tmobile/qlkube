# qlkube 
![example workflow](https://github.com/tmobile/qlkube/actions/workflows/main.yml/badge.svg)
...
- expose _all_ the types and operations from the Kubernetes rest api in its grapqhl api
